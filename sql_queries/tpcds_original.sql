...
-- =================================================================
-- Query ID: TPCDS_Q2
-- Description: Compare weekly sales of web and catalog channels across
-- two years.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q3
-- Description: Aggregate sales by brand for a specific manufacturer
-- in a specific month.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q4
-- Description: Compare customer spending habits across store, catalog,
-- and web channels between two specific years.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q5
-- Description: Calculate sales, returns, and profit totals for store,
-- catalog, and web channels for a specific 14-day period.
-- =================================================================
with ssr as 
	(select s_store_id,sum(sales_price) as sales,
		sum(profit) as profit,
		sum(return_amt) as "returns",
		sum(net_loss) as profit_loss from
...
-- =================================================================
-- Query ID: TPCDS_Q6
-- Description: List states with at least 10 customers who purchased
-- items priced higher than the average in a specific month.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q7
-- Description: Compute average quantity, list price, discount, and sales
-- price for items purchased by specific demographic groups.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q8
-- Description: Compute net profit for stores located in zip codes with
-- a high density of preferred customers.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q9
-- Description: Categorize store sales into quantity buckets and calculate
-- average tax or net paid based on count thresholds.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q10
-- Description: Count customers by demographics who purchased from store
-- and either web or catalog channels in a specific year.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q11
-- Description: Customer spending analysis comparing store and web sales for the year 1999.
-- =================================================================
with year_total as (
...
-- =================================================================
-- Query ID: TPCDS_Q12
-- Description: Revenue ratio analysis for items in Men, Books, and Electronics categories over a 30-day period.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q13
-- Description: Store sales average statistics for specific demographic and state combinations in 2001.
-- =================================================================
...
where s_store_sk = ss_store_sk
 ...
 and d_year = 2001
 and((ss_hdemo_sk=hd_demo_sk and cd_demo_sk = ss_cdemo_sk and cd_marital_status = 'M' and cd_education_status = 'College' and ss_sales_price between 100.00 and 150.00 and hd_dep_count = 3 )
  or (ss_hdemo_sk=hd_demo_sk and cd_demo_sk = ss_cdemo_sk and cd_marital_status = 'D' and cd_education_status = 'Primary' and ss_sales_price between 50.00 and 100.00 and hd_dep_count = 1 )
  or (ss_hdemo_sk=hd_demo_sk and cd_demo_sk = ss_cdemo_sk and cd_marital_status = 'W' and cd_education_status = '2 yr Degree' and ss_sales_price between 150.00 and 200.00 and hd_dep_count = 1 ))
 and((ss_addr_sk = ca_address_sk and ca_country = 'United States' and ca_state in ('IL','TN','TX') and ss_net_profit between 100 and 200 )
  or (ss_addr_sk = ca_address_sk and ca_country = 'United States' and ca_state in ('WY','OH','ID') and ss_net_profit between 150 and 300 )
  or (ss_addr_sk = ca_address_sk and ca_country = 'United States' and ca_state in ('MS','SC','IA') and ss_net_profit between 50 and 250 ));
...
-- =================================================================
-- Query ID: TPCDS_Q15
-- Description: Aggregates catalog sales by zip code and state for the second quarter of 2001.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q16
-- Description: Calculates order count and shipping costs for Williamson County, PA, with no returns.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q17
-- Description: Detailed analysis of store sales, store returns, and catalog sales quantities by item and state.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q18
-- Description: Rollup analysis of catalog sales metrics by location for specific customer demographics in 2001.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q19
-- Description: Top brands by sales price for a specific manager and month in 2002.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q20
-- Description: Catalog sales revenue ratio for Books, Music, and Sports items in mid-2002.
-- =================================================================
select i_item_id,i_item_desc,i_category,i_class,i_current_price,sum(cs_ext_sales_price) as itemrevenue,sum(cs_ext_sales_price)*100/sum(sum(cs_ext_sales_price)) over (partition by i_class) as revenueratio
...
-- =================================================================
-- Query ID: TPCDS_Q21
-- Description: Analysis of inventory quantity changes for specific items around June 1999.
-- =================================================================
select * from(select w_warehouse_name,i_item_id,sum(case when (cast(d_date as date) < cast ('1999-06-22' as date)) then inv_quantity_on_hand else 0 end) as inv_before,sum(case when (cast(d_date as date) >= cast ('1999-06-22' as date)) then inv_quantity_on_hand else 0 end) as inv_after
...
-- =================================================================
-- Query ID: TPCDS_Q22
-- Description: Average inventory quantity on hand by product class and category over a 12-month sequence.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q23
-- Description: Retrieves all records from the customer table (duplicate check).
-- =================================================================
select * from customer;

-- =================================================================
-- Query ID: TPCDS_Q24
-- Description: Identifies high-value customers purchasing 'khaki' colored items.
-- =================================================================
with ssales as (
...
-- =================================================================
-- Query ID: TPCDS_Q25
-- Description: Comparison of store sales profit, return loss, and catalog sales profit for items in 1999.
-- =================================================================
select i_item_id,i_item_desc,s_store_id,s_store_name,max(ss_net_profit) as store_sales_profit,max(sr_net_loss) as store_returns_loss,max(cs_net_profit) as catalog_sales_profit
from store_sales,store_returns,catalog_sales,date_dim d1,date_dim d2,date_dim d3,store,item
where d1.d_moy = 4
 and d1.d_year = 1999
 and d1.d_date_sk = ss_sold_date_sk
...
-- =================================================================
-- Query ID: TPCDS_Q26
-- Description: Aggregates catalog sales metrics for specific demographics and non-email/event promotions in 2002.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q27
-- Description: Rollup analysis of store sales by item and state for specific demographics in 1999.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q30
-- Description: Finds customers in Indiana with returns significantly higher than the state average in 2000.
-- =================================================================
WITH customer_total_return AS (
...
-- =================================================================
-- Query ID: TPCDS_Q31
-- Description: Computes quarterly sales increases for store and web channels using Common Table Expressions (CTEs) to compare Q1-Q2 and Q2-Q3 growth.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q32
-- Description: Calculates the excess discount amount for catalog sales where the discount exceeds 1.3 times the average discount for similar items within a 90-day window.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q33
-- Description: Aggregates total sales across store, catalog, and web channels for the 'Books' category by manufacturer for a specific month and year.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q34
-- Description: Identifies customers with specific buying potentials and demographic criteria (vehicle count, dependent count) who made frequent purchases in Williamson County stores.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q35
-- Description: Aggregates customer demographics and state data for customers who have made purchases across store, web, or catalog channels in the first three quarters of 1999.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q37
-- Description: Lists items with specific price ranges and inventory levels sold through catalog channels within a 60-day window starting March 29, 2002.
-- =================================================================
select i_item_id,i_item_desc,i_current_price from item,inventory,date_dim,catalog_sales where i_current_price between 29 and 29 + 30 and inv_item_sk = i_item_sk and d_date_sk=inv_date_sk and d_date between cast('2002-03-29' as date) and (cast('2002-03-29' as date) + interval '60' day) and i_manufact_id in (393,174,251,445) and inv_quantity_on_hand between 100 and 500 and cs_item_sk = i_item_sk group by i_item_id,i_item_desc,i_current_price order by i_item_id limit 100;

-- =================================================================
-- Query ID: TPCDS_Q38
-- Description: Counts the number of distinct customers who made purchases across all three channels (store, catalog, and web) within a specific 12-month period.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q39
-- Description: Analyzes inventory stability by comparing the coefficient of variation in inventory levels between consecutive months for items with high variance.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q40
-- Description: Compares catalog sales (net of returns) before and after May 2, 2001, grouped by warehouse state and item.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q41
-- Description: Selects distinct product names from specific manufacturers where items match complex combinations of category, color, units, and size.
-- =================================================================
select distinct(i_product_name) from item i1 where i_manufact_id between 704 and 704 + 40 and ( select count(*) as item_cnt from item where ( i_manufact = i1.i_manufact and ( ( i_category = 'Women' and ( i_color = 'forest' or i_color = 'lime' ) and ( i_units = 'Pallet' or i_units = 'Pound' ) and ( i_size = 'economy' or i_size = 'small' ) ) or ( i_category = 'Women' and ( i_color = 'navy' or i_color = 'slate' ) and ( i_units = 'Gross' or i_units = 'Bunch' ) and ( i_size = 'extra large' or i_size = 'petite' ) ) or ( i_category = 'Men' and ( i_color = 'powder' or i_color = 'sky' ) and ( i_units = 'Dozen' or i_units = 'Lb' ) and ( i_size = 'N/A' or i_size = 'large' ) ) or ( i_category = 'Men' and ( i_color = 'maroon' or i_color = 'smoke' ) and ( i_units = 'Ounce' or i_units = 'Case' ) and ( i_size = 'economy' or i_size = 'small' ) ) ) ) or ( i_manufact = i1.i_manufact and ( ( i_category = 'Women' and ( i_color = 'dark' or i_color = 'aquamarine' ) and ( i_units = 'Ton' or i_units = 'Tbl' ) and ( i_size = 'economy' or i_size = 'small' ) ) or ( i_category = 'Women' and ( i_color = 'frosted' or i_color = 'plum' ) and ( i_units = 'Dram' or i_units = 'Box' ) and ( i_size = 'extra large' or i_size = 'petite' ) ) or ( i_category = 'Men' and ( i_color = 'papaya' or i_color = 'peach' ) and ( i_units = 'Bundle' or i_units = 'Carton' ) and ( i_size = 'N/A' or i_size = 'large' ) ) or ( i_category = 'Men' and ( i_color = 'firebrick' or i_color = 'sienna' ) and ( i_units = 'Cup' or i_units = 'Each' ) and ( i_size = 'economy' or i_size = 'small' ) ) ) ) ) > 0 order by i_product_name limit 100;

-- =================================================================
-- Query ID: TPCDS_Q42
-- Description: Aggregates store sales revenue by year and item category for a specific manager ID in November 1998.
-- =================================================================
select dt.d_year,item.i_category_id,item.i_category,sum(ss_ext_sales_price) from date_dim dt,store_sales,item where dt.d_date_sk = store_sales.ss_sold_date_sk and store_sales.ss_item_sk = item.i_item_sk and item.i_manager_id = 1 and dt.d_moy=11 and dt.d_year=1998 group by dt.d_year,item.i_category_id,item.i_category order by sum(ss_ext_sales_price) desc,dt.d_year,item.i_category_id,item.i_category limit 100 ;

-- =================================================================
-- Query ID: TPCDS_Q43
-- Description: Pivots store sales data to show the daily sales distribution (Sunday to Saturday) for each store in the year 2000.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q44
-- Description: Identifies and pairs the best and worst performing items based on net profit rankings within a specific store.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q45
-- Description: Aggregates web sales revenue by zip code and city for specific zip codes or items during the first quarter of 2000.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q46
-- Description: Lists customers who purchased items in a city different from their current residence, filtered by specific demographic and date criteria.
-- =================================================================
select c_last_name,c_first_name,ca_city,bought_city,ss_ticket_number,amt,profit from (select ss_ticket_number,ss_customer_sk,ca_city bought_city,sum(ss_coupon_amt) amt,sum(ss_net_profit) profit from store_sales,date_dim,store,household_demographics,customer_address where store_sales.ss_sold_date_sk = date_dim.d_date_sk and store_sales.ss_store_sk = store.s_store_sk and store_sales.ss_hdemo_sk = household_demographics.hd_demo_sk and store_sales.ss_addr_sk = customer_address.ca_address_sk and (household_demographics.hd_dep_count = 8 or household_demographics.hd_vehicle_count= 0) and date_dim.d_dow in (4,0) and date_dim.d_year in (2000,2000+1,2000+2) and store.s_city in ('Midway','Fairview','Fairview','Midway','Fairview') group by ss_ticket_number,ss_customer_sk,ss_addr_sk,ca_city) dn,customer,customer_address current_addr where ss_customer_sk = c_customer_sk and customer.c_current_addr_sk = current_addr.ca_address_sk and current_addr.ca_city <> bought_city order by c_last_name,c_first_name,ca_city,bought_city,ss_ticket_number limit 100;

-- =================================================================
-- Query ID: TPCDS_Q47
-- Description: Uses window functions to analyze monthly store sales deviations from the average and compares sales with previous and subsequent months.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q48
-- Description: Calculates the total quantity of store sales matching specific combinations of customer marital status, education, and state.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q49
-- Description: Unions and compares return ratios and currency rankings for top items across web, catalog, and store sales channels.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q50
-- Description: Categorizes store returns into 30-day intervals (30 days, 31-60 days, etc.) based on the delay between the sale and return dates.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q51
-- Description: Calculates cumulative sales for store and web channels and compares the maximum cumulative sales between the two for items sold in a specific date range.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q52
-- Description: Aggregates store sales by brand for a specific manager and month, ordering by year and extended price.
-- =================================================================
select dt.d_year,item.i_brand_id brand_id,item.i_brand brand,sum(ss_ext_sales_price) ext_price from date_dim dt,store_sales,item where dt.d_date_sk = store_sales.ss_sold_date_sk and store_sales.ss_item_sk = item.i_item_sk and item.i_manager_id = 1 and dt.d_moy=12 and dt.d_year=2000 group by dt.d_year,item.i_brand,item.i_brand_id order by dt.d_year,ext_price desc,brand_id limit 100 ;

-- =================================================================
-- Query ID: TPCDS_Q53
-- Description: Identifies manufacturers with significant sales deviations by comparing quarterly sales to the average quarterly sales for specific item categories.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q54
-- Description: Segments customers based on their revenue generation in store sales, grouping them into bins of 50.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q55
-- Description: Calculates the total extended price for brand items sold by manager 52 in November 2000.
-- =================================================================
select i_brand_id brand_id,i_brand brand,sum(ss_ext_sales_price) ext_price from date_dim,store_sales,item where d_date_sk = ss_sold_date_sk and ss_item_sk = i_item_sk and i_manager_id=52 and d_moy=11 and d_year=2000 group by i_brand,i_brand_id order by ext_price desc,i_brand_id limit 100 ;

-- =================================================================
-- Query ID: TPCDS_Q56
-- Description: Aggregates total sales for items of specific colors (powder, orchid, pink) across store, catalog, and web channels.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q57
-- Description: Analyzes monthly sales deviations for call centers using lag and lead window functions to compare with previous and subsequent months.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q58
-- Description: Compares revenue across store, catalog, and web channels for items sold in a specific week, calculating the percentage deviation from the average.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q59
-- Description: Calculates the ratio of store sales for each day of the week between two consecutive years.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q60
-- Description: Aggregates total sales for the 'Jewelry' category across store, catalog, and web channels for a specific month and year.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q63
-- Description: Computes the deviation of monthly store sales from the average monthly sales for specific managers and item categories.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q64
-- Description: Identifies cross-channel sales patterns where catalog items were refunded at a high rate, correlating with store sales of specific colors.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q65
-- Description: Lists items and stores where the item revenue is significantly lower (less than 10%) than the average item revenue for that store.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q66
-- Description: Aggregates monthly web and catalog sales by warehouse, including sales per square foot and net paid amounts for a specific year and shipping carrier.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q67
-- Description: Performs a rollup aggregation of store sales by category, class, brand, and product name to find top-ranking item groups.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q68
-- Description: Lists customers who made store purchases in a city different from their current residence city (specifically Fairview/Midway).
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q69
-- Description: Analyzes customer demographics (gender, marital status, education) for customers who shop in stores but do NOT shop via web or catalog.
-- =================================================================
select cd_gender,cd_marital_status,cd_education_status,count(*) cnt1,cd_purchase_estimate,count(*) cnt2,cd_credit_rating,count(*) cnt3 from customer c,customer_address ca,customer_demographics where c.c_current_addr_sk = ca.ca_address_sk and ca_state in ('IL','TX','ME') and cd_demo_sk = c.c_current_cdemo_sk and exists (select * from store_sales,date_dim where c.c_customer_sk = ss_customer_sk and ss_sold_date_sk = d_date_sk and d_year = 2002 and d_moy between 1 and 1+2) and (not exists (select * from web_sales,date_dim where c.c_customer_sk = ws_bill_customer_sk and ws_sold_date_sk = d_date_sk and d_year = 2002 and d_moy between 1 and 1+2) and not exists (select * from catalog_sales,date_dim where c.c_customer_sk = cs_ship_customer_sk and cs_sold_date_sk = d_date_sk and d_year = 2002 and d_moy between 1 and 1+2)) group by cd_gender,cd_marital_status,cd_education_status,cd_purchase_estimate,cd_credit_rating order by cd_gender,cd_marital_status,cd_education_status,cd_purchase_estimate,cd_credit_rating limit 100; 
...
-- =================================================================
-- Query ID: TPCDS_Q71
-- Description: Aggregates sales by brand and time for specific managers and meal times.
-- =================================================================
select i_brand_id brand_id,i_brand brand,t_hour,t_minute,sum(ext_price) ext_price from item,(select ws_ext_sales_price as ext_price,ws_sold_date_sk as sold_date_sk,ws_item_sk as sold_item_sk,ws_sold_time_sk as time_sk from web_sales,date_dim where d_date_sk = ws_sold_date_sk and d_moy=12 and d_year=2002 union all select cs_ext_sales_price as ext_price,cs_sold_date_sk as sold_date_sk,cs_item_sk as sold_item_sk,cs_sold_time_sk as time_sk from catalog_sales,date_dim where d_date_sk = cs_sold_date_sk and d_moy=12 and d_year=2002 union all select ss_ext_sales_price as ext_price,ss_sold_date_sk as sold_date_sk,ss_item_sk as sold_item_sk,ss_sold_time_sk as time_sk from store_sales,date_dim where d_date_sk = ss_sold_date_sk and d_moy=12 and d_year=2002 ) tmp,time_dim where sold_item_sk = i_item_sk and i_manager_id=1 and time_sk = t_time_sk and (t_meal_time = 'breakfast' or t_meal_time = 'dinner') group by i_brand,i_brand_id,t_hour,t_minute order by ext_price desc,i_brand_id ; 

-- =================================================================
-- Query ID: TPCDS_Q72
-- Description: Analyzes catalog sales against inventory levels, including demographic data.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q73
-- Description: Retrieves customer details for those with specific purchase frequencies and demographics.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q74
-- Description: Compares year-over-year customer spending across store and web channels.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q75
-- Description: Calculates sales difference between current and previous year for the 'Sports' category.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q76
-- Description: Aggregates sales count and amount across store, web, and catalog channels.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q77
-- Description: Summarizes sales, returns, and profit across all channels for a 30-day window.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q78
-- Description: Compares store sales ratios against combined web and catalog sales.
-- =================================================================
with ws as ( select d_year AS ws_sold_year,ws_item_sk,ws_bill_customer_sk ws_customer_sk,sum(ws_quantity) ws_qty,sum(ws_wholesale_cost) ws_wc,sum(ws_sales_price) ws_sp from web_sales left join web_returns wr on wr.wr_order_number = ws_order_number and ws_item_sk = wr.wr_item_sk join date_dim on ws_sold_date_sk = d_date_sk where wr.wr_order_number is null group by d_year,ws_item_sk,ws_bill_customer_sk ),cs as ( select d_year AS cs_sold_year,cs_item_sk,cs_bill_customer_sk cs_customer_sk,sum(cs_quantity) cs_qty,sum(cs_wholesale_cost) cs_wc,sum(cs_sales_price) cs_sp from catalog_sales left join catalog_returns cr on cr.cr_order_number = cs_order_number and cs_item_sk = cr.cr_item_sk join date_dim on cs_sold_date_sk = d_date_sk where cr.cr_order_number is null group by d_year,cs_item_sk,cs_bill_customer_sk ),ss as ( select d_year AS ss_sold_year,ss_item_sk,ss_customer_sk,sum(ss_quantity) ss_qty,sum(ss_wholesale_cost) ss_wc,sum(ss_sales_price) ss_sp from store_sales left join store_returns sr on sr.sr_ticket_number = ss_ticket_number and ss_item_sk = sr.sr_item_sk join date_dim on ss_sold_date_sk = d_date_sk where sr.sr_ticket_number is null group by d_year,ss_item_sk,ss_customer_sk ) select ss_customer_sk,round( ss_qty /(coalesce(ws_qty,0) + coalesce(cs_qty,0)),2 ) ratio,ss_qty store_qty,ss_wc store_wholesale_cost,ss_sp store_sales_price,coalesce(ws_qty,0) + coalesce(cs_qty,0) other_chan_qty,coalesce(ws_wc,0) + coalesce(cs_wc,0) other_chan_wholesale_cost,coalesce(ws_sp,0) + coalesce(cs_sp,0) other_chan_sales_price from ss left join ws on ( ws_sold_year = ss_sold_year and ws_item_sk = ss_item_sk and ws_customer_sk = ss_customer_sk ) left join cs on ( cs_sold_year = ss_sold_year and cs_item_sk = ss_item_sk and cs_customer_sk = ss_customer_sk ) where ( coalesce(ws_qty,0) > 0 or coalesce(cs_qty,0) > 0 ) and ss_sold_year = 1998 order by ss_customer_sk,ss_qty desc,ss_wc desc,ss_sp desc,other_chan_qty,other_chan_wholesale_cost,other_chan_sales_price,ratio limit 100;

-- =================================================================
-- Query ID: TPCDS_Q79
-- Description: Lists customers based on ticket amount and profit from specific store types.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q80
-- Description: Analyzes profit for high-value items across store, catalog, and web channels.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q81
-- Description: Identifies customers with high return amounts relative to their state's average.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q82
-- Description: Lists items with specific current price range and manufacturing details.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q83
-- Description: Compares return quantities across store, catalog, and web sales for specific dates.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q84
-- Description: Lists customers from a specific city and income band.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q85
-- Description: Analyzes return reasons by demographics and refund amounts for web sales.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q90
-- Description: Calculates the ratio of web sales counts between AM and PM hours.
-- =================================================================
select cast(amc as decimal(15,4))/cast(pmc as decimal(15,4)) am_pm_ratio from ( select count(*) amc from web_sales,household_demographics,time_dim,web_page where ws_sold_time_sk = time_dim.t_time_sk and ws_ship_hdemo_sk = household_demographics.hd_demo_sk and ws_web_page_sk = web_page.wp_web_page_sk and time_dim.t_hour between 12 and 12+1 and household_demographics.hd_dep_count = 6 and web_page.wp_char_count between 5000 and 5200) am_tbl,( select count(*) pmc from web_sales,household_demographics,time_dim,web_page where ws_sold_time_sk = time_dim.t_time_sk and ws_ship_hdemo_sk = household_demographics.hd_demo_sk and ws_web_page_sk = web_page.wp_web_page_sk and time_dim.t_hour between 14 and 14+1 and household_demographics.hd_dep_count = 6 and web_page.wp_char_count between 5000 and 5200) pm_tbl order by am_pm_ratio limit 100;

-- =================================================================
-- Query ID: TPCDS_Q91
-- Description: Aggregates returns loss by call center and customer demographics.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q94
-- Description: Calculates order metrics for web sales in OK with multi-warehouse shipments.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q95
-- Description: Calculates order metrics for web sales in VA with multi-warehouse shipments and returns.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q96
-- Description: Counts store sales with specific time and demographic constraints.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q97
-- Description: Analyzes customers purchasing only from store, only from catalog, or both.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q98
-- Description: Lists items with revenue ratios within their class for specific categories.
-- =================================================================
...
-- =================================================================
-- Query ID: TPCDS_Q99
-- Description: Categorizes catalog sales by shipping delay intervals.
-- =================================================================
